# BIO594 Week 6 Exercise
## Kevin Wong
## March 5 2018

The following code was used in Step 33 in the Ref.Ex tutorial:

`(Ref_Ex) [kwong@KITT Rad_Ref]$ bash ReferenceOpt.sh 4 8 4 8 PE 16 &`
...
To look at kopt.data, I used:

`(Ref_Ex) [kwong@KITT Rad_Ref]$ cat kopt.data`
```
4 4 0.80 1000
4 4 0.82 1000
4 4 0.84 1000
